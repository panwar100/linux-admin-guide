...
- [Recurring Scheduling Using crontab](#b-recurring-scheduling-using-crontab)
...
**i) Restart the system and edit the GRUB entry during boot**.
...
**ii) Add the following to the kernel line**:
...
**a) Edit the GRUB boot entry and add:kotlin**

    rd.break
![Screenshot from 2025-01-11 00-09-22](https://github.com/user-attachments/assets/8d8b3ee3-c41a-48aa-94bb-9028d37114e3)

![Screenshot from 2025-01-11 00-10-27](https://github.com/user-attachments/assets/e4640fa9-a874-4dbf-a719-75987eb73b6b)


Boot into emergency mode.

**b) Remount sysroot with read-write permissions**:

 ![Screenshot from 2025-01-11 00-14-41](https://github.com/user-attachments/assets/55f5fdfd-f312-458c-b0b7-110c7b4dcc01)


**c) Switch to the root filesystem**:
 
![Screenshot from 2025-01-11 00-15-58](https://github.com/user-attachments/assets/0a1c8cd0-808e-46c8-a1ba-3d07a4b8ef78)


**d) Reset the root password**:

![Screenshot from 2025-01-11 00-17-34](https://github.com/user-attachments/assets/acb0e3e0-9618-49ab-b0d5-960c2eb1e1b1)


**e) Relabel SELinux context for changes**:
    
![Screenshot from 2025-01-11 00-19-35](https://github.com/user-attachments/assets/b6979163-7424-4d76-8f7e-12c2948b6175)


**f) Exit and reboot the system**:

![Screenshot from 2025-01-11 00-20-51](https://github.com/user-attachments/assets/819c3b9c-5e3a-4da5-8719-edce1db5a1d4)
...
**b) View scheduled tasks**:

    atq

**c) Delete a specific task (e.g., task ID 8)**:
...
**b) Display all cron jobs**:

    crontab -l

**c) Delete all cron jobs**:

    crontab -r

**d) Edit crontab for a specific user (e.g., tom)**:
